...
const Plans = () => {
  return (
    <div className='max-w-[1200px] m-auto py-18 px-4 grid lg:grid-cols-2 gap-4'>
    {/* Left Side */}
    ...
    <div className='flex flex-col h-full justify-center'>
      ...
      <p className='text-2xl py-6'>
        Start planning your trip today and get the advantages of early-bird discounts!
      </p>
      <p className='pb-6'>
        We provide assistance for you to have best experience for your holiday. 
        It is always super easy to plan and manage your holiday with the best serice, 
        our team is ready to response anytime and anywhere!
      </p>
      <div>
